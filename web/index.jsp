...
<%
    ...
    <%-- Paso 3: Hacer que le servicio sea visible para EL y JSTL--%>
<c:set var="servicio" scope="page" value="<%=servicio%>"/> <%--   <----   JSTL     --%>
...
<div class="row">
    <div class="col s6 offset-s3">
        <div class="card-panel">
            <p class="center-aling"><span class="blue-text text-darken-2">Ingresar Productos</span></p>
            ...
            <div class="input-field col s6">
                ...
                <button type="submit" class="btn">Guardar <i class="material-icons">check</i></button>
            </form>
        </div>
